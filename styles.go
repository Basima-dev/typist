...
var (
	...
	// Syntax highlight (pending chars in code mode)
	hlKeyword  = lipgloss.NewStyle().Foreground(lipgloss.Color("#cba6f7"))
	hlBuiltin  = lipgloss.NewStyle().Foreground(lipgloss.Color("#89dceb"))
	hlString   = lipgloss.NewStyle().Foreground(lipgloss.Color("#a6e3a1"))
	hlComment  = lipgloss.NewStyle().Foreground(lipgloss.Color("#6c7086"))
	hlNumber   = lipgloss.NewStyle().Foreground(lipgloss.Color("#fab387"))
	hlPunct    = lipgloss.NewStyle().Foreground(lipgloss.Color("#89b4fa"))

	// WPM sparkline
	sparkBarStyle  = lipgloss.NewStyle().Foreground(lipgloss.Color("#cba6f7"))
	sparkPeakStyle = lipgloss.NewStyle().Foreground(lipgloss.Color("#f9e2af"))
