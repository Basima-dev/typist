...
Just click the copy button in the top-right of the code block, or triple-click to select all and copy! 🚀To make a README truly "beautiful" for a developer tool, it needs to strike a balance between **terminal-chic aesthetics** and **high-density information**.
